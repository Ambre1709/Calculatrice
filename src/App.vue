  ...
  <div class="">
    ...
    <div class="container flex justify-center">
      ...
      >
        ...
        <div
          class="bg-teal-800 dark:bg-purpletor-dark text-white dark:text-yellowtor p-6 rounded-md"
        >
          <div class="grid grid-cols-4 gap-4">
            <div class="relative cursor-pointer" @click="operate(7)">
              <div
                class="relative z-10 bg-yellow-500 dark:bg-purpletor rounded-md h-14 flex items-center justify-center text-xl"
              >
                7
              </div>
              <div
                class="absolute -bottom-1 right-0 bg-yellow-800 dark:bg-purpletor-light rounded-md h-14 w-full"
              ></div>
            </div>
            ...
            <div class="text-white relative cursor-pointer" @click="drop()">
              <div
                class="relative z-10 bg-red-500 dark:bg-purpletor-light rounded-md h-14 flex items-center justify-center text-xl"
              >
                DEL
              </div>
              <div
                class="absolute -bottom-1 right-0 bg-red-900 dark:bg-purpletor-lightest rounded-md h-14 w-full"
              ></div>
            </div>
            ...
            <div class="relative cursor-pointer col-span-2" @click="cleanAll()">
              <div
                class="text-white relative z-10 bg-red-500 dark:bg-purpletor-light rounded-md h-14 flex items-center justify-center text-xl"
              >
                RESET
              </div>
              <div
            ...
            <div class="relative cursor-pointer col-span-2" @click="equal()">
              <div
                class="text-black relative z-10 bg-white dark:bg-bluetor rounded-md h-14 flex items-center justify-center text-xl"
              >
                =
              </div>
              <div
                class="absolute -bottom-1 right-0 bg-gray-300 dark:bg-bluetor-light rounded-md h-14 w-full"
              ></div>
            </div>
          </div>
        </div>
